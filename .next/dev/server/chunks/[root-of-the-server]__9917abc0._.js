...
"[project]/OneDrive/Desktop/ELHOUSSEIN FILES/BrandFlox/website/app/api/contact/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$OneDrive$2f$Desktop$2f$ELHOUSSEIN__FILES$2f$BrandFlox$2f$website$2f$node_modules$2f$nodemailer$2f$lib$2f$nodemailer$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/OneDrive/Desktop/ELHOUSSEIN FILES/BrandFlox/website/node_modules/nodemailer/lib/nodemailer.js [app-route] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$OneDrive$2f$Desktop$2f$ELHOUSSEIN__FILES$2f$BrandFlox$2f$website$2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/OneDrive/Desktop/ELHOUSSEIN FILES/BrandFlox/website/node_modules/next/server.js [app-route] (ecmascript)");
;
;
const transporter = __TURBOPACK__imported__module__$5b$project$5d2f$OneDrive$2f$Desktop$2f$ELHOUSSEIN__FILES$2f$BrandFlox$2f$website$2f$node_modules$2f$nodemailer$2f$lib$2f$nodemailer$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].createTransport({
    service: "gmail",
    auth: {
...
const icons = {
    ...
    building: '<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" width="16" height="16"><rect x="4" y="2" width="16" height="20" rx="2"/><path d="M9 22v-4h6v4M9 9h6M9 13h6"/></svg>',
    message: '<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" width="16" height="16"><path d="M21 15a2 2 0 0 1-2 2H7l-4 4V5a2 2 0 0 1 2-2h14a2 2 0 0 1 2 2z"/></svg>',
    whatsapp: '<svg xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 24 24" width="20" height="20"><path d="M20.52 3.48A11.78 11.78 0 0012 0 11.94 11.94 0 000 12a11.84 11.84 0 001.69 6L0 24l6.17-1.62A11.93 11.93 0 0012 24a11.94 11.94 0 0012-12 11.78 11.78 0 00-3.48-8.52zM12 22a9.94 9.94 0 01-5.08-1.39l-.36-.21-3.65.96.97-3.56-.24-.37A9.92 9.92 0 1122 12a9.84 9.84 0 01-10 10zm5.44-7.36c-.3-.15-1.77-.87-2.04-.97s-.47-.15-.66.15-.75.97-.92 1.17-.34.22-.64.07a8.18 8.18 0 01-2.4-1.48 9 9 0 01-1.66-2.07c-.17-.3 0-.46.13-.61s.3-.35.45-.52a1.93 1.93 0 00.3-.52.56.56 0 00-.02-.54c-.07-.15-.66-1.6-.91-2.2s-.48-.48-.66-.49h-.57a1.11 1.11 0 00-.8.37A3.36 3.36 0 006 10.73a5.84 5.84 0 001.24 3.08 13.34 13.34 0 004.05 3.67 13.17 13.17 0 003.15 1.27 3 3 0 002.88-.47 2.34 2.34 0 00.71-1.56c.1-.15.1-.57-.2-.72z"/></svg>',
    email: '<svg xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 24 24" width="20" height="20"><path d="M20 4H4c-1.1 0-1.99.9-1.99 2L2 18c0 1.1.9 2 2 2h16c1.1 0 2-.9 2-2V6c0-1.1-.9-2-2-2zm0 4l-8 5-8-5V6l8 5 8-5v2z"/></svg>',
    instagram: '<svg xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 24 24" width="20" height="20"><path d="M12 2.163c3.204 0 3.584.012 4.85.07 1.17.055 1.965.24 2.417.403a4.918 4.918 0 011.675 1.035 4.918 4.918 0 011.034 1.675c.164.452.348 1.247.403 2.417.058 1.266.07 1.646.07 4.85s-.012 3.584-.07 4.85c-.055 1.17-.24 1.965-.403 2.417a4.918 4.918 0 01-1.035 1.675 4.918 4.918 0 01-1.675 1.034c-.452.164-1.247.348-2.417.403-1.266.058-1.646.07-4.85.07s-3.584-.012-4.85-.07c-1.17-.055-1.965-.24-2.417-.403a4.918 4.918 0 01-1.675-1.035 4.918 4.918 0 01-1.034-1.675c-.164-.452-.348-1.247-.403-2.417C2.175 15.747 2.163 15.367 2.163 12s.012-3.584.07-4.85c.055-1.17.24-1.965.403-2.417a4.918 4.918 0 011.035-1.675A4.918 4.918 0 015.346 2.636c.452-.164 1.247-.348 2.417-.403C8.416 2.175 8.796 2.163 12 2.163zm0-2.163C8.736 0 8.332.012 7.052.07 5.773.127 4.832.309 4.052.548c-.86.273-1.59.634-2.318 1.362C1.63 2.64 1.269 3.37.996 4.23.757 5.01.575 5.95.518 7.23.46 8.51.448 8.914.448 12c0 3.086.012 3.49.07 4.77.057 1.28.239 2.22.478 3 .273.86.634 1.59 1.362 2.318.728.728 1.458 1.089 2.318 1.362.78.239 1.72.421 3 .478 1.28.058 1.684.07 4.77.07s3.49-.012 4.77-.07c1.28-.057 2.22-.239 3-.478.86-.273 1.59-.634 2.318-1.362.728-.728 1.089-1.458 1.362-2.318.239-.78.421-1.72.478-3 .058-1.28.07-1.684.07-4.77s-.012-3.49-.07-4.77c-.057-1.28-.239-2.22-.478-3-.273-.86-.634-1.59-1.362-2.318C21.632.63 20.902.269 20.042.037c-.78-.239-1.72-.421-3-.478C15.49.012 15.086 0 12 0zM12 5.838a6.162 6.162 0 100 12.324 6.162 6.162 0 000-12.324zm0 10.162a3.999 3.999 0 110-7.998 3.999 3.999 0 010 7.998zm6.406-11.845a1.44 1.44 0 11-2.88 0 1.44 1.44 0 012.88 0z"/></svg>'
};
function getOwnerEmailTemplate(data, language) {
    const content = {
        en: {
...
function getClientEmailTemplate(language) {
    const content = {
        en: {
            greeting: "Thank You for Contacting Brandflox",
            subtitle: "We've received your message",
            message: "We appreciate you reaching out to us. Our team will carefully review your inquiry and get back to you within <strong>24 hours</strong>.",
        ...
        fr: {
            ...
            message: "Nous apprécions que vous nous ayez contactés. Notre équipe examinera attentivement votre demande et vous répondra dans les <strong>24 heures</strong>.",
...
async function POST(request) {
    try {
        ...
        if (!name || !email || !phone || !message) {
            ...
            return __TURBOPACK__imported__module__$5b$project$5d2f$OneDrive$2f$Desktop$2f$ELHOUSSEIN__FILES$2f$BrandFlox$2f$website$2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
        ...
        await transporter.sendMail({
            ...
            subject: language === "fr" ? `Nouvelle Soumission du Formulaire de ${name}` : `New Contact Form Submission from ${name}`,
...
//# sourceMappingURL=%5Broot-of-the-server%5D__9917abc0._.js.map